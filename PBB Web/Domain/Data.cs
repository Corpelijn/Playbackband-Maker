using PBB_Web.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Web;

namespace PBB_Web.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            //menu.Add(new Navbar { Id = 21, nameOption = "Playbackband luisteren", controller = "playbackband", action = "main", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 2, nameOption = "Charts", imageClass = "fa fa-bar-chart-o fa-fw", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id = 3, nameOption = "Flot Charts", controller = "playbackband", action = "main", status = true, isParent = false, parentId = 2 });
